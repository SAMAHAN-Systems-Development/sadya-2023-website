...
const Footer = () => {
  return (
    <div className="xsm:p-8 p-6 h-auto bg-white flex md:flex-row flex-col justify-between md:space-y-0 space-y-4 text-black">
      ...
      <div className="text-right flex md:flex-col flex-row sm:space-x-10 space-x-7 md:justify-between justify-center items-center">
        <h2 className="font-extrabold md:text-3xl sm:text-4xl text-2xl text-center">SADYA 2023</h2>
