...
const NavigationBar: React.FC<NavType> = ({ isDevPage }) => {
  ...
  return (
    <div
      className={`${
        isDevPage ? 'fixed w-full ' : 'sticky'
      } flex ease-in-out z-50 top-0 items-start justify-between px-6 py-4 bg-gradient-to-b from-white via-white-50 to-transparent h-[11.25rem] transition-opacity ${
